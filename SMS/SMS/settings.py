...
SECRET_KEY = 'django-insecure-r8b!&*z@=ztia0f-7333bjd2*srgn$@#w$k!%-ifdltt+@g-%7'
...
MIDDLEWARE = [
    ...
    'studentapp.middleware.CacheControlMiddleware',
]
...
# Session settings for persistent session after server restarts
SESSION_ENGINE = 'django.contrib.sessions.backends.db'  # Store sessions in the database
SESSION_COOKIE_AGE = 3600  # 1 hour session duration in seconds
